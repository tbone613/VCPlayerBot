...
class Config:
    ...
    ADMIN = os.environ.get("6800876826", '')
    ...
    #Database
    DATABASE_URI=os.environ.get("mongodb+srv://trevorboyne613:tr13bo93fg@cluster0.hbtktuh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", None)
